...
namespace GBCSporting_Huskies.Controllers
{
    public class TechniciansController : Controller
    {
        ...
        public TechniciansController(SportingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TechnicianId,Firstname,Lastname,Phone,Email")] Technician technician)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TechnicianId,Firstname,Lastname,Phone,Email")] Technician technician)
        {
